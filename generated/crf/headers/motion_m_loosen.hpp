...
inline bool can_start_motion_m_loosen(
    ...
    shared.wrench_ee_ee.torque.z_err = motion_spec::runtime::evaluate_greater_than_constraint(shared.wrench_ee_ee.torque[2], shared.torque_loosen_min_contact);

    return true&& motion_spec::runtime::constraint_satisfied(shared.wrench_ee_ee.torque.z_err);
}
...
inline void monitor_motion_m_loosen(
    ...
    motion_spec::runtime::set_flag(
        ...
        motion_spec::runtime::constraint_satisfied(shared.wrench_ee_ee.torque.z_err));
    ...
    shared.pose_arm_ee_world.rotation.z_err = motion_spec::runtime::evaluate_bilateral_constraint(shared.pose_arm_ee_world.rotation.z, shared.rotation_loosen_lower, shared.rotation_loosen_upper);
    // eval_m_loosen_until_cstr_torque_loosen_bilateral
    shared.wrench_ee_ee.torque.z_err = motion_spec::runtime::evaluate_bilateral_constraint(shared.wrench_ee_ee.torque[2], shared.torque_loosen_lower, shared.torque_loosen_upper);
...
inline void control_motion_m_loosen(
    ...
    shared.twist_ee_ee.angular.z_err_m_loosen = motion_spec::runtime::evaluate_equality_constraint(shared.twist_ee_ee.rot[2], shared.angvel_ee_z_ref_loosen);
    ...
    // ctrl_angvel_loosen
    shared.eacc_twist_ee_ee.angular.z_m_loosen = state.ctrl_angvel_loosen.control(shared.twist_ee_ee.angular.z_err_m_loosen);
