...
int main() {
    ...
    kinova_tree.getChain("base_link", "Bracelet_Link", chain_arm_solver);
    ...
    while (true) {
        ...
        case 0: {
            ...
            if (!motion_m_approach_state_instance.active && can_start_motion_m_approach(motion_m_approach_state_instance, shared)) {
                motion_m_approach_state_instance.active = true;
            }
            if (motion_m_approach_state_instance.active) {
                ...
                if (motion_spec::runtime::constraint_satisfied(shared.wrench_ee_force_z_err) && motion_spec::runtime::constraint_satisfied(shared.wrench_ee_force_z_err)) {
                    motion_m_approach_state_instance.active = false;
                    current_motion = 1;
                }
            }
            break;
        ...
        case 1: {
            ...
            if (!motion_m_contact_state_instance.active && can_start_motion_m_contact(motion_m_contact_state_instance, shared)) {
                motion_m_contact_state_instance.active = true;
            }
            if (motion_m_contact_state_instance.active) {
                ...
                if (motion_spec::runtime::constraint_satisfied(shared.wrench_ee_force_z_err)) {
                    motion_m_contact_state_instance.active = false;
                    current_motion = 2;
                }
            }
            break;
