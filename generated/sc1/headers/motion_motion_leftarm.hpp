...
inline void control_motion_motion_leftarm(
    ...
    state.left_arm_solver.f_ext[motion_spec::runtime::find_segment_index(*robot.left_arm_solver.chain, "link_platform") - 1] += shared.wrench_force_ctrl_dist_leftarm_shoulder_ee;
