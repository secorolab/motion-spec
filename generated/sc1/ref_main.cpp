...
int main() {
    ...
    kinova_state kinova_slv_sc1_rightarm_state{};
    kinova_slv_sc1_rightarm_state.ctrl_mode = ROBIF2B_CTRL_MODE_FORCE;

    robif2b_kinova_gen3_nbx kinova_slv_sc1_rightarm{};
    kinova_slv_sc1_rightarm.conf.ip_address = "127.0.0.1";
    kinova_slv_sc1_rightarm.conf.port = 10000;
    kinova_slv_sc1_rightarm.conf.port_real_time = 10001;
    kinova_slv_sc1_rightarm.conf.user = "admin";
    kinova_slv_sc1_rightarm.conf.password = "admin";
    kinova_slv_sc1_rightarm.conf.session_timeout = 60000;
    kinova_slv_sc1_rightarm.conf.connection_timeout = 2000;
    kinova_slv_sc1_rightarm.ctrl_mode = &kinova_slv_sc1_rightarm_state.ctrl_mode;
    kinova_slv_sc1_rightarm.jnt_pos_msr = &kinova_slv_sc1_rightarm_state.pos_msr[0];
    kinova_slv_sc1_rightarm.jnt_vel_msr = &kinova_slv_sc1_rightarm_state.vel_msr[0];
    kinova_slv_sc1_rightarm.jnt_trq_msr = &kinova_slv_sc1_rightarm_state.eff_msr[0];
    kinova_slv_sc1_rightarm.act_cur_msr = &kinova_slv_sc1_rightarm_state.cur_msr[0];
    kinova_slv_sc1_rightarm.jnt_pos_cmd = &kinova_slv_sc1_rightarm_state.pos_cmd[0];
    kinova_slv_sc1_rightarm.jnt_vel_cmd = &kinova_slv_sc1_rightarm_state.vel_cmd[0];
    kinova_slv_sc1_rightarm.jnt_trq_cmd = &kinova_slv_sc1_rightarm_state.eff_cmd[0];
    kinova_slv_sc1_rightarm.act_cur_cmd = &kinova_slv_sc1_rightarm_state.cur_cmd[0];
    kinova_slv_sc1_rightarm.success = &kinova_slv_sc1_rightarm_state.success;

    KDL::Chain chain_slv_sc1_rightarm;
    kinova_tree.getChain("base_link", "Bracelet_Link", chain_slv_sc1_rightarm);

    robot.slv_sc1_rightarm = manipulator_robot{
        .state = &kinova_slv_sc1_rightarm_state,
        .robot = &kinova_slv_sc1_rightarm,
        .chain = &chain_slv_sc1_rightarm,
    };

    kinova_state kinova_slv_sc1_leftarm_state{};
    kinova_slv_sc1_leftarm_state.ctrl_mode = ROBIF2B_CTRL_MODE_FORCE;

    robif2b_kinova_gen3_nbx kinova_slv_sc1_leftarm{};
    kinova_slv_sc1_leftarm.conf.ip_address = "127.0.0.1";
    kinova_slv_sc1_leftarm.conf.port = 10000;
    kinova_slv_sc1_leftarm.conf.port_real_time = 10001;
    kinova_slv_sc1_leftarm.conf.user = "admin";
    kinova_slv_sc1_leftarm.conf.password = "admin";
    kinova_slv_sc1_leftarm.conf.session_timeout = 60000;
    kinova_slv_sc1_leftarm.conf.connection_timeout = 2000;
    kinova_slv_sc1_leftarm.ctrl_mode = &kinova_slv_sc1_leftarm_state.ctrl_mode;
    kinova_slv_sc1_leftarm.jnt_pos_msr = &kinova_slv_sc1_leftarm_state.pos_msr[0];
    kinova_slv_sc1_leftarm.jnt_vel_msr = &kinova_slv_sc1_leftarm_state.vel_msr[0];
    kinova_slv_sc1_leftarm.jnt_trq_msr = &kinova_slv_sc1_leftarm_state.eff_msr[0];
    kinova_slv_sc1_leftarm.act_cur_msr = &kinova_slv_sc1_leftarm_state.cur_msr[0];
    kinova_slv_sc1_leftarm.jnt_pos_cmd = &kinova_slv_sc1_leftarm_state.pos_cmd[0];
    kinova_slv_sc1_leftarm.jnt_vel_cmd = &kinova_slv_sc1_leftarm_state.vel_cmd[0];
    kinova_slv_sc1_leftarm.jnt_trq_cmd = &kinova_slv_sc1_leftarm_state.eff_cmd[0];
    kinova_slv_sc1_leftarm.act_cur_cmd = &kinova_slv_sc1_leftarm_state.cur_cmd[0];
    kinova_slv_sc1_leftarm.success = &kinova_slv_sc1_leftarm_state.success;

    KDL::Chain chain_slv_sc1_leftarm;
    kinova_tree.getChain("base_link", "Bracelet_Link", chain_slv_sc1_leftarm);

    robot.slv_sc1_leftarm = manipulator_robot{
        .state = &kinova_slv_sc1_leftarm_state,
        .robot = &kinova_slv_sc1_leftarm,
        .chain = &chain_slv_sc1_leftarm,
    };
    ...
    robif2b_kinova_gen3_configure(&kinova_slv_sc1_rightarm);
    robif2b_kinova_gen3_recover(&kinova_slv_sc1_rightarm);
    robif2b_kinova_gen3_start(&kinova_slv_sc1_rightarm);

    robif2b_kinova_gen3_configure(&kinova_slv_sc1_leftarm);
    robif2b_kinova_gen3_recover(&kinova_slv_sc1_leftarm);
    robif2b_kinova_gen3_start(&kinova_slv_sc1_leftarm);
    ...
    robif2b_kinova_gen3_stop(&kinova_slv_sc1_rightarm);
    robif2b_kinova_gen3_shutdown(&kinova_slv_sc1_rightarm);

    robif2b_kinova_gen3_stop(&kinova_slv_sc1_leftarm);
    robif2b_kinova_gen3_shutdown(&kinova_slv_sc1_leftarm);
