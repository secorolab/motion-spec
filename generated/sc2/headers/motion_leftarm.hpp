...
struct slv_sc2_leftarm_solver_state {
...
struct motion_leftarm_state {
    slv_sc2_leftarm_solver_state slv_sc2_leftarm;
...
inline void init_motion_leftarm(motion_leftarm_state &state, const robot_io &robot) {
    if (!state.slv_sc2_leftarm.initialized) {
        state.slv_sc2_leftarm.num_constraints = 5;
        state.slv_sc2_leftarm.num_joints = robot.slv_sc2_leftarm.chain->getNrOfJoints();
        state.slv_sc2_leftarm.num_segments = robot.slv_sc2_leftarm.chain->getNrOfSegments();
        state.slv_sc2_leftarm.q = KDL::JntArray(state.slv_sc2_leftarm.num_joints);
        state.slv_sc2_leftarm.qd = KDL::JntArray(state.slv_sc2_leftarm.num_joints);
        state.slv_sc2_leftarm.qdd = KDL::JntArray(state.slv_sc2_leftarm.num_joints);
        state.slv_sc2_leftarm.tau_ff = KDL::JntArray(state.slv_sc2_leftarm.num_joints);
        state.slv_sc2_leftarm.tau_ctrl = KDL::JntArray(state.slv_sc2_leftarm.num_joints);
        state.slv_sc2_leftarm.f_ext = KDL::Wrenches(state.slv_sc2_leftarm.num_segments);
        state.slv_sc2_leftarm.f_cstr = KDL::Jacobian(state.slv_sc2_leftarm.num_constraints);
        state.slv_sc2_leftarm.e_acc = KDL::JntArray(state.slv_sc2_leftarm.num_constraints);
        state.slv_sc2_leftarm.achd_fext = std::make_unique<KDL::ChainHdSolver_Vereshchagin_Fext>(*robot.slv_sc2_leftarm.chain, state.slv_sc2_leftarm.root_acc, state.slv_sc2_leftarm.num_constraints);
        state.slv_sc2_leftarm.achd_acc = std::make_unique<KDL::ChainHdSolver_Vereshchagin>(*robot.slv_sc2_leftarm.chain, state.slv_sc2_leftarm.root_acc, state.slv_sc2_leftarm.num_constraints);
        state.slv_sc2_leftarm.initialized = true;
}
}
...
inline void update_motion_leftarm(
    ...
    for (int i = 0; i < state.slv_sc2_leftarm.num_joints; ++i) {
        state.slv_sc2_leftarm.q(i) = robot.slv_sc2_leftarm.state->pos_msr[i];
        state.slv_sc2_leftarm.qd(i) = robot.slv_sc2_leftarm.state->vel_msr[i];
    }
    KDL::JntArrayVel q_qd_slv_sc2_leftarm(state.slv_sc2_leftarm.q, state.slv_sc2_leftarm.qd);
    {
        KDL::ChainFkSolverPos_recursive fk(*robot.slv_sc2_leftarm.chain);
        fk.JntToCart(
            state.slv_sc2_leftarm.q,
            shared.pose_leftarm_shoulder_elbow,
            motion_spec::runtime::find_segment_index(*robot.slv_sc2_leftarm.chain, "frame_leftarm_elbow"));
    }

    {
        ...
        fk.JntToCart(
            ...
            motion_spec::runtime::find_segment_index(*robot.slv_sc2_leftarm.chain, "frame_leftarm_ee"));
    }

    {
        KDL::ChainFkSolverVel_recursive fk(*robot.slv_sc2_leftarm.chain);
        KDL::FrameVel tmp;
        fk.JntToCart(
            q_qd_slv_sc2_leftarm,
            tmp,
            motion_spec::runtime::find_segment_index(*robot.slv_sc2_leftarm.chain, "link_leftarm_ee"));
...
inline void control_motion_leftarm(
    ...
    KDL::SetToZero(state.slv_sc2_leftarm.f_cstr);
    state.slv_sc2_leftarm.f_cstr(motion_spec::runtime::constraint_row(motion_spec::runtime::Subspace::Linear, motion_spec::runtime::Axis::Y), 0) = 1.0;
state.slv_sc2_leftarm.e_acc(0) = shared.eacc_leftarm_world_ee_lin_y;
    state.slv_sc2_leftarm.f_cstr(motion_spec::runtime::constraint_row(motion_spec::runtime::Subspace::Angular, motion_spec::runtime::Axis::X), 1) = 1.0;
state.slv_sc2_leftarm.e_acc(1) = shared.eacc_leftarm_shoulder_ee_ang_x;
    state.slv_sc2_leftarm.f_cstr(motion_spec::runtime::constraint_row(motion_spec::runtime::Subspace::Angular, motion_spec::runtime::Axis::Y), 2) = 1.0;
state.slv_sc2_leftarm.e_acc(2) = shared.eacc_leftarm_shoulder_ee_ang_y;
    state.slv_sc2_leftarm.f_cstr(motion_spec::runtime::constraint_row(motion_spec::runtime::Subspace::Angular, motion_spec::runtime::Axis::Z), 3) = 1.0;
state.slv_sc2_leftarm.e_acc(3) = shared.eacc_leftarm_shoulder_ee_ang_z;
    state.slv_sc2_leftarm.f_cstr(motion_spec::runtime::constraint_row(motion_spec::runtime::Subspace::Linear, motion_spec::runtime::Axis::Z), 4) = 1.0;
state.slv_sc2_leftarm.e_acc(4) = shared.eacc_leftarm_shoulder_ee_lin_z;
    for (int i = 0; i < state.slv_sc2_leftarm.num_segments; ++i) {
        KDL::SetToZero(state.slv_sc2_leftarm.f_ext[i]);
    }
    state.slv_sc2_leftarm.f_ext[motion_spec::runtime::find_segment_index(*robot.slv_sc2_leftarm.chain, "link_leftarm_ee") - 1] += shared.wrench_leftarm_ee_anteroposterior_platform;
    state.slv_sc2_leftarm.f_ext[motion_spec::runtime::find_segment_index(*robot.slv_sc2_leftarm.chain, "link_leftarm_elbow") - 1] += shared.wrench_leftarm_elbow;
    state.slv_sc2_leftarm.f_ext[motion_spec::runtime::find_segment_index(*robot.slv_sc2_leftarm.chain, "link_leftarm_ee") - 1] += shared.wrench_leftarm_dist_shoulder;
    KDL::JntArray tau_ctrl_fext_slv_sc2_leftarm(state.slv_sc2_leftarm.num_joints);
    state.slv_sc2_leftarm.achd_fext->CartToJnt(
        state.slv_sc2_leftarm.q,
        state.slv_sc2_leftarm.qd,
        state.slv_sc2_leftarm.qdd,
        state.slv_sc2_leftarm.f_cstr,
        state.slv_sc2_leftarm.e_acc,
        state.slv_sc2_leftarm.f_ext,
        state.slv_sc2_leftarm.tau_ff,
        tau_ctrl_fext_slv_sc2_leftarm);
    KDL::Wrenches f_ext_zero_slv_sc2_leftarm(state.slv_sc2_leftarm.num_segments);
    KDL::JntArray tau_ctrl_acc_slv_sc2_leftarm(state.slv_sc2_leftarm.num_joints);
    state.slv_sc2_leftarm.achd_acc->CartToJnt(
        state.slv_sc2_leftarm.q,
        state.slv_sc2_leftarm.qd,
        state.slv_sc2_leftarm.qdd,
        state.slv_sc2_leftarm.f_cstr,
        state.slv_sc2_leftarm.e_acc,
        f_ext_zero_slv_sc2_leftarm,
        state.slv_sc2_leftarm.tau_ff,
        tau_ctrl_acc_slv_sc2_leftarm);
    KDL::Add(tau_ctrl_fext_slv_sc2_leftarm, tau_ctrl_acc_slv_sc2_leftarm, state.slv_sc2_leftarm.tau_ctrl);
}
...
inline void apply_motion_leftarm(
    ...
    const robot_io &robot) {
    for (int i = 0; i < state.slv_sc2_leftarm.num_joints; ++i) {
        robot.slv_sc2_leftarm.state->eff_cmd[i] = state.slv_sc2_leftarm.tau_ctrl(i);
    }
    robif2b_kinova_gen3_update(robot.slv_sc2_leftarm.robot);
}