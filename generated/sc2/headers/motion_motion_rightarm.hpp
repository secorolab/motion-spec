...
inline void control_motion_motion_rightarm(
    ...
    state.right_arm_solver.f_ext[motion_spec::runtime::find_segment_index(*robot.right_arm_solver.chain, "link_rightarm_ee") - 1] += shared.wrench_force_ctrl_dist_rightarm_shoulder_ee;
