...
struct slv_sc2_rightarm_solver_state {
...
struct motion_rightarm_state {
    slv_sc2_rightarm_solver_state slv_sc2_rightarm;
...
inline void init_motion_rightarm(motion_rightarm_state &state, const robot_io &robot) {
    if (!state.slv_sc2_rightarm.initialized) {
        state.slv_sc2_rightarm.num_constraints = 5;
        state.slv_sc2_rightarm.num_joints = robot.slv_sc2_rightarm.chain->getNrOfJoints();
        state.slv_sc2_rightarm.num_segments = robot.slv_sc2_rightarm.chain->getNrOfSegments();
        state.slv_sc2_rightarm.q = KDL::JntArray(state.slv_sc2_rightarm.num_joints);
        state.slv_sc2_rightarm.qd = KDL::JntArray(state.slv_sc2_rightarm.num_joints);
        state.slv_sc2_rightarm.qdd = KDL::JntArray(state.slv_sc2_rightarm.num_joints);
        state.slv_sc2_rightarm.tau_ff = KDL::JntArray(state.slv_sc2_rightarm.num_joints);
        state.slv_sc2_rightarm.tau_ctrl = KDL::JntArray(state.slv_sc2_rightarm.num_joints);
        state.slv_sc2_rightarm.f_ext = KDL::Wrenches(state.slv_sc2_rightarm.num_segments);
        state.slv_sc2_rightarm.f_cstr = KDL::Jacobian(state.slv_sc2_rightarm.num_constraints);
        state.slv_sc2_rightarm.e_acc = KDL::JntArray(state.slv_sc2_rightarm.num_constraints);
        state.slv_sc2_rightarm.achd_fext = std::make_unique<KDL::ChainHdSolver_Vereshchagin_Fext>(*robot.slv_sc2_rightarm.chain, state.slv_sc2_rightarm.root_acc, state.slv_sc2_rightarm.num_constraints);
        state.slv_sc2_rightarm.achd_acc = std::make_unique<KDL::ChainHdSolver_Vereshchagin>(*robot.slv_sc2_rightarm.chain, state.slv_sc2_rightarm.root_acc, state.slv_sc2_rightarm.num_constraints);
        state.slv_sc2_rightarm.initialized = true;
}
}
...
inline void update_motion_rightarm(
    ...
    for (int i = 0; i < state.slv_sc2_rightarm.num_joints; ++i) {
        state.slv_sc2_rightarm.q(i) = robot.slv_sc2_rightarm.state->pos_msr[i];
        state.slv_sc2_rightarm.qd(i) = robot.slv_sc2_rightarm.state->vel_msr[i];
    }
    KDL::JntArrayVel q_qd_slv_sc2_rightarm(state.slv_sc2_rightarm.q, state.slv_sc2_rightarm.qd);
    {
        KDL::ChainFkSolverPos_recursive fk(*robot.slv_sc2_rightarm.chain);
        fk.JntToCart(
            state.slv_sc2_rightarm.q,
            shared.pose_rightarm_shoulder_elbow,
            motion_spec::runtime::find_segment_index(*robot.slv_sc2_rightarm.chain, "frame_rightarm_elbow"));
    }

    {
        ...
        fk.JntToCart(
            ...
            motion_spec::runtime::find_segment_index(*robot.slv_sc2_rightarm.chain, "frame_rightarm_ee"));
    }

    {
        KDL::ChainFkSolverVel_recursive fk(*robot.slv_sc2_rightarm.chain);
        KDL::FrameVel tmp;
        fk.JntToCart(
            q_qd_slv_sc2_rightarm,
            tmp,
            motion_spec::runtime::find_segment_index(*robot.slv_sc2_rightarm.chain, "link_rightarm_ee"));
...
inline void monitor_motion_rightarm(
    motion_rightarm_state &state,
    shared_data &shared) {
}
...
inline void control_motion_rightarm(
    ...
    KDL::SetToZero(state.slv_sc2_rightarm.f_cstr);
    state.slv_sc2_rightarm.f_cstr(motion_spec::runtime::constraint_row(motion_spec::runtime::Subspace::Linear, motion_spec::runtime::Axis::Y), 0) = 1.0;
state.slv_sc2_rightarm.e_acc(0) = shared.eacc_rightarm_world_ee_lin_y;
    state.slv_sc2_rightarm.f_cstr(motion_spec::runtime::constraint_row(motion_spec::runtime::Subspace::Angular, motion_spec::runtime::Axis::X), 1) = 1.0;
state.slv_sc2_rightarm.e_acc(1) = shared.eacc_rightarm_shoulder_ee_ang_x;
    state.slv_sc2_rightarm.f_cstr(motion_spec::runtime::constraint_row(motion_spec::runtime::Subspace::Angular, motion_spec::runtime::Axis::Y), 2) = 1.0;
state.slv_sc2_rightarm.e_acc(2) = shared.eacc_rightarm_shoulder_ee_ang_y;
    state.slv_sc2_rightarm.f_cstr(motion_spec::runtime::constraint_row(motion_spec::runtime::Subspace::Angular, motion_spec::runtime::Axis::Z), 3) = 1.0;
state.slv_sc2_rightarm.e_acc(3) = shared.eacc_rightarm_shoulder_ee_ang_z;
    state.slv_sc2_rightarm.f_cstr(motion_spec::runtime::constraint_row(motion_spec::runtime::Subspace::Linear, motion_spec::runtime::Axis::Z), 4) = 1.0;
state.slv_sc2_rightarm.e_acc(4) = shared.eacc_rightarm_shoulder_ee_lin_z;
    for (int i = 0; i < state.slv_sc2_rightarm.num_segments; ++i) {
        KDL::SetToZero(state.slv_sc2_rightarm.f_ext[i]);
    }
    state.slv_sc2_rightarm.f_ext[motion_spec::runtime::find_segment_index(*robot.slv_sc2_rightarm.chain, "link_rightarm_ee") - 1] += shared.wrench_rightarm_ee_anteroposterior_platform;
    state.slv_sc2_rightarm.f_ext[motion_spec::runtime::find_segment_index(*robot.slv_sc2_rightarm.chain, "link_rightarm_elbow") - 1] += shared.wrench_rightarm_elbow;
    state.slv_sc2_rightarm.f_ext[motion_spec::runtime::find_segment_index(*robot.slv_sc2_rightarm.chain, "link_rightarm_ee") - 1] += shared.wrench_rightarm_dist_shoulder;
    KDL::JntArray tau_ctrl_fext_slv_sc2_rightarm(state.slv_sc2_rightarm.num_joints);
    state.slv_sc2_rightarm.achd_fext->CartToJnt(
        state.slv_sc2_rightarm.q,
        state.slv_sc2_rightarm.qd,
        state.slv_sc2_rightarm.qdd,
        state.slv_sc2_rightarm.f_cstr,
        state.slv_sc2_rightarm.e_acc,
        state.slv_sc2_rightarm.f_ext,
        state.slv_sc2_rightarm.tau_ff,
        tau_ctrl_fext_slv_sc2_rightarm);
    KDL::Wrenches f_ext_zero_slv_sc2_rightarm(state.slv_sc2_rightarm.num_segments);
    KDL::JntArray tau_ctrl_acc_slv_sc2_rightarm(state.slv_sc2_rightarm.num_joints);
    state.slv_sc2_rightarm.achd_acc->CartToJnt(
        state.slv_sc2_rightarm.q,
        state.slv_sc2_rightarm.qd,
        state.slv_sc2_rightarm.qdd,
        state.slv_sc2_rightarm.f_cstr,
        state.slv_sc2_rightarm.e_acc,
        f_ext_zero_slv_sc2_rightarm,
        state.slv_sc2_rightarm.tau_ff,
        tau_ctrl_acc_slv_sc2_rightarm);
    KDL::Add(tau_ctrl_fext_slv_sc2_rightarm, tau_ctrl_acc_slv_sc2_rightarm, state.slv_sc2_rightarm.tau_ctrl);
}
...
inline void apply_motion_rightarm(
    ...
    const robot_io &robot) {
    for (int i = 0; i < state.slv_sc2_rightarm.num_joints; ++i) {
        robot.slv_sc2_rightarm.state->eff_cmd[i] = state.slv_sc2_rightarm.tau_ctrl(i);
    }
    robif2b_kinova_gen3_update(robot.slv_sc2_rightarm.robot);
}