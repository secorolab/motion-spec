...
"""Characterization tests for the IRI-shape scene-reading helpers in ir.py (plan 022 step 1).

Pins today's output of body resolution, _tree_owns/_mapped_targets/_kinematic_adjacency across the
three maintained models plus real_demo, so step 3's graph-derived replacement fails loudly if
it changes an answer. Values below are recorded as-is, not reasoned "correct" answers -- some
look surprising (see the report) but are recorded verbatim per plan 022 step 1's instruction.
"""
...
MODEL_NAMES = ["pick_place_single", "pick_place_dual", "admittance_arc_single", "real_demo"]


def _characterize(name, tmp_path):
    """DSL-compile <name>.robmot to JSON-LD, run the current IR pipeline once, and record what
    body_of_frame/_mapped_targets/_kinematic_adjacency/_tree_owns produce for it today."""
    ...
    _app_path, g, _imported, _prov = _load_graph(manifest)

    frames = sorted(g.subjects(RDF.type, GEOM_ENT.Frame), key=str)
    body_of = {str(frame): str(body_of_frame(frame, g)) for frame in frames}

    targets = {str(t) for t in _mapped_targets(g, AGN["AgentModel"], GEOM_ENT.KinematicTree)}
...
def characterized(request, tmp_path_factory):
    name = request.param
    body_of, targets, edges, tree_owns = _characterize(name, tmp_path_factory.mktemp(name))
    return name, body_of, targets, edges, tree_owns


def test_body_of_every_frame(characterized):
    """The body each geom:Frame sits on, as scene-dsl resolves it from the graph."""
    name, body_of, _targets, _edges, _tree_owns = characterized
...
def test_mapped_targets_kinematic_tree(characterized):
    """_mapped_targets(g, AGN.AgentModel, GEOM_ENT.KinematicTree)."""
    name, _body_of, targets, _edges, _tree_owns = characterized
    assert targets == _MAPPED_TARGETS[name]


def test_kinematic_adjacency_edges(characterized):
    """_kinematic_adjacency(g) edges, as sorted (body_a, body_b) string pairs."""
    name, _body_of, _targets, edges, _tree_owns = characterized
    assert edges == _ADJACENCY_EDGES[name]


def test_tree_owns_pairs_the_lowering_asks(characterized):
    """_tree_owns(tree, node) for every pair a real generate_ir() run actually asks."""
    name, _body_of, _targets, _edges, tree_owns = characterized
    expected = _TREE_OWNS[name]
    assert len(tree_owns) == len(expected)
    assert tree_owns == expected
...
_TREE_OWNS = {
    "pick_place_single": {
        ...
        (
            "https://secorolab.github.io/models/scenes/pick-place-single-mjc/ft_tree",
            "https://secorolab.github.io/models/scenes/pick-place-single-mjc/gripper/g_base/g_pinch",
        ): False,
        (
            "https://secorolab.github.io/models/scenes/pick-place-single-mjc/ft_tree",
            "https://secorolab.github.io/models/scenes/pick-place-single-mjc/gripper/g_base_mount",
        ...
        (
            "https://secorolab.github.io/models/scenes/pick-place-single-mjc/ft_tree",
            "https://secorolab.github.io/models/scenes/pick-place-single-mjc/gripper/g_left_driver_joint",
        ): False,
        (
            "https://secorolab.github.io/models/scenes/pick-place-single-mjc/ft_tree",
            "https://secorolab.github.io/models/scenes/pick-place-single-mjc/kinova/base_link",
        ...
        (
            "https://secorolab.github.io/models/scenes/pick-place-single-mjc/ft_tree",
            "https://secorolab.github.io/models/scenes/pick-place-single-mjc/kinova/base_link/base_link_origin",
        ): False,
        (
            "https://secorolab.github.io/models/scenes/pick-place-single-mjc/ft_tree",
            "https://secorolab.github.io/models/scenes/pick-place-single-mjc/kinova/bracelet_link",
        ...
        (
            "https://secorolab.github.io/models/scenes/pick-place-single-mjc/ft_tree",
            "https://secorolab.github.io/models/scenes/pick-place-single-mjc/pick_place_graph/cube",
        ): False,
        (
            "https://secorolab.github.io/models/scenes/pick-place-single-mjc/ft_tree",
            "https://secorolab.github.io/models/scenes/pick-place-single-mjc/world_tree/table",
    ...
    "pick_place_dual": {
        ...
        (
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/gripper1",
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/gripper1/g_base/g_pinch",
        ): True,
        (
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/gripper1",
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/gripper1/g_base_mount",
        ...
        (
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/gripper1",
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/gripper1/g_left_driver_joint",
        ): True,
        (
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/gripper1",
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/gripper2/g_base",
        ...
        (
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/gripper1",
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/gripper2/g_base/g_pinch",
        ): False,
        (
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/gripper1",
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/gripper2/g_base_mount",
        ...
        (
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/gripper1",
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/gripper2/g_left_driver_joint",
        ): False,
        (
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/gripper1",
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/kinova1/base_link",
        ...
        (
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/gripper1",
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/pick_place_graph/cube",
        ): False,
        (
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/gripper1",
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/pick_place_graph/cube2",
        ): False,
        (
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/gripper1",
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/world_tree/table",
        ...
        (
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/gripper2",
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/kinova1/base_link/base_link_origin",
        ): False,
        (
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/gripper2",
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/kinova1/bracelet_link",
        ...
        (
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/kinova2",
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/kinova2/base_link/base_link_origin",
        ): True,
        (
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/kinova2",
            "https://secorolab.github.io/models/scenes/pick-place-dual-mjc/kinova2/bracelet_link",
    ...
    "admittance_arc_single": {
        ...
        (
            "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/ft_tree",
            "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/ft_tree/wrist_ft_body/wrist_ft_site",
        ): True,
        (
            "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/ft_tree",
            "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/gripper/g_base",
        ...
        (
            "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/ft_tree",
            "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/gripper/g_base/g_pinch",
        ): False,
        (
            "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/ft_tree",
            "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/gripper/g_base_mount",
        ...
        (
            "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/ft_tree",
            "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/kinova/base_link/base_link_origin",
        ): False,
        (
            "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/ft_tree",
            "https://secorolab.github.io/models/scenes/admittance-arc-single-mjc/kinova/bracelet_link",
